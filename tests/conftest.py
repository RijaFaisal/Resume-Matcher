...
app.state.METRICS = {
    ...
    "load_time_seconds": get_or_create_metric("model_load_seconds", Gauge, "Time taken to load models"),
    "errors_total": get_or_create_metric("api_errors_total", Counter, "Total API errors", ["error_type"]),
    "similarity_score": get_or_create_metric("match_similarity_score", Histogram, "Distribution of similarity scores", ["model_version"]),
    "http_requests_duration": get_or_create_metric("http_request_duration_seconds", Histogram, "HTTP request latency", ["method","endpoint","status_code"]),
}
