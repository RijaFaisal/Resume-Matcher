...
**Milestone 2 UI (Streamlit)**
*The updated interface for matching resumes.*
![Streamlit UI](./docs/screenshots/u1.png)
**Milestone 2 UI for Chat (Streamlit)**
*The new interface for chatbot.*
![Streamlit UI](./docs/screenshots/u2.png)
**Milestone 2; Resume generated by Chatbot(Streamlit)**
*The pdf generated by the chatbot.*
![Streamlit UI](./docs/screenshots/u3.png)
