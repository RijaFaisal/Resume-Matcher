...
class CostCalculator:
    ...
    def calculate_cost(
        ...
        model_pricing = pricing.get(
            model, pricing.get("default", {"prompt": 0, "completion": 0})
        )
...
class LLMMetricsTracker:
    ...
    def start_request(
        self, provider: LLMProvider, model: str, request_id: Optional[str] = None
    ):
    ...
    def record_output(self, output_text: str):
        ...
        self.completion_tokens = TokenCounter.estimate_tokens(
    ...
    def end_request(self, success: bool = True) -> LLMMetrics:
        ...
        costs = CostCalculator.calculate_cost(
            self.provider, self.model_name, self.prompt_tokens, self.completion_tokens
        )
    ...
    def get_aggregate_stats(self) -> Dict:
        ...
        avg_latency = (
            sum(m.total_latency_ms for m in self.metrics_history) / total_requests
        )
